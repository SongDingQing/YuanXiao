...
- `bridge/yuanxiao-hermes-bridge/` - Mac mini bridge from ChangE to Hermes, Codex, vision, session dashboard, and Codex session chat.
...
- Current app version: `0.28`
- Delivery APK name: `yuanxiao-0.28.apk`
